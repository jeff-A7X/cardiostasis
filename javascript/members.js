...
let memberPhotos = ['img/aaronF.png', 'img/jeffF.jpeg', 'img/koenF.jpeg'];
let memberNames = ['Alex Kokee', 'Jeff Stasis ', "Koen"];
let memberFirstNames = ['Alex', 'Jeff', 'Koen'];
let memberInfo = [  "I’m the voalist and rhythm guitarist for Cardiostasis. I’ve been into loud rock music since I can remember and I started playing guitar at 14. My influences range from heavy bands like (Acid Bath, Melvins, TAD) to alt-rock (Pixies, Sonic Youth, Talking Heads), grunge (Nirvana, Alice In Chains, L7), and punk and classic icons (Fugazi, Dead Kennedys, Bowie, The Beatles), and much more. That mix shapes my sound and my approach to songwriting.",
  " I'm the lead guitarist and backing vocalist for Cardiostasis, also lead guitarist & backing vocalist for my 2nd band, Death By Distortion. I've always had a huge passion for loud raw heavy and melodic music. All my emotion and energy goes into crafting and enjoying music influenced greatly by bands like Bullet for My Valentine, Trivium, Parkway Drive and other heavy hitting emotional bands from the metalcore scene. Whether on stage, in the studio or even at home, I'm all about the balance of creating the most hard hitting, headbanging riffs and vocals along with producing the most touching and emotional music.",
