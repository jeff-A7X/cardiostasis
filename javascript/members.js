...
let memberInfo = [  "I’m the lead vocalist, songwriter, and rhythm guitarist for Cardiostasis. I’ve been into loud rock music since I can remember and I started playing guitar at 14. My influences range from heavy bands like (Acid Bath, Melvins, Death) to alt-rock (Pixies, Sonic Youth, Talking Heads), grunge (Nirvana, Alice In Chains, L7), and the punk and classic icons (Fugazi, Dead Kennedys, Bowie, The Beatles), and much more. That mix shapes my sound and my approach to songwriting.",
